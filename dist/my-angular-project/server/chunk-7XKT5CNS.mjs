    ...
    this.mockUsers = [
      {
        ...
        name: "Dog Lover",
        avatar: "\u{1F415}",
        dateJoined: /* @__PURE__ */ new Date("2023-01-15"),
        role: "user"
      },
      {
        id: "2",
        ...
        name: "Admin User",
        avatar: "\u{1F464}",
        dateJoined: /* @__PURE__ */ new Date("2023-01-01"),
        role: "admin"
      }
    ];
...
var DogCategory;
(function(DogCategory2) {
  DogCategory2["BREEDS"] = "breeds";
  DogCategory2["FOOD"] = "food";
  DogCategory2["ENVIRONMENT"] = "environment";
  DogCategory2["TRAINING"] = "training";
  DogCategory2["HEALTH"] = "health";
  DogCategory2["GROOMING"] = "grooming";
})(DogCategory || (DogCategory = {}));

// src/app/services/dog.service.ts
var _DogService = class _DogService {
  constructor() {
    this.dogBreeds = [
      {
        id: "1",
    ...
    this.dogPosts = [
      ...
      },
      {
        ...
        date: /* @__PURE__ */ new Date("2024-01-08"),
        createdAt: /* @__PURE__ */ new Date("2024-01-08"),
  ...
  searchBreeds(query) {
    const filtered = this.dogBreeds.filter((breed) => breed.name.toLowerCase().includes(query.toLowerCase()) || breed.description.toLowerCase().includes(query.toLowerCase()) || breed.temperament.some((trait) => trait.toLowerCase().includes(query.toLowerCase())));
    return of(filtered);
  }
  getBreedById(id) {
  ...
  getPostsByTag(tag) {
    const filtered = this.dogPosts.filter((post) => post.tags.some((postTag) => postTag.toLowerCase() === tag.toLowerCase()));
    return of(filtered.sort((a, b) => b.date.getTime() - a.date.getTime()));
  }
  searchPosts(query) {
    const filtered = this.dogPosts.filter((post) => post.title.toLowerCase().includes(query.toLowerCase()) || post.content.toLowerCase().includes(query.toLowerCase()) || post.tags.some((tag) => tag.toLowerCase().includes(query.toLowerCase())) || post.author.name.toLowerCase().includes(query.toLowerCase()));
    return of(filtered.sort((a, b) => b.date.getTime() - a.date.getTime()));
  }
  // Mock admin methods
  ...
  getUserProfile(userId) {
    const mockProfile = {
      ...
      email: "doglover@example.com",
      name: "Dog Lover",
      bio: "\u{1F415} Passionate dog owner and trainer. Love sharing tips and stories about our furry friends!",
  ...
  updateUserProfile(userId, updates) {
    const updatedProfile = __spreadValues({}, updates);
...
_DogService.\u0275fac = function DogService_Factory(t) {
  return new (t || _DogService)();
};
_DogService.\u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _DogService, factory: _DogService.\u0275fac, providedIn: "root" });
var DogService = _DogService;
...
@angular/forms/fesm2022/forms.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-7XKT5CNS.mjs.map
